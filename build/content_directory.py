...
<section class="section">
  <div class="wrap">
    {answer("miamicontactimprov.com is an independent community resource that maps Contact Improvisation (CI) practice across Miami-Dade and Broward County. It publishes what can be verified, states plainly what cannot, and accepts corrections from anyone in the scene. It hosts one session, the Friday jam in Miami, listed on the same terms as every other entry; it takes no bookings and charges nothing for listings.")}
    <div class="prose">
      <h2>Why it exists</h2>
