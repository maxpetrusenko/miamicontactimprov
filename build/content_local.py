...
def _sessions_block():
    ...
    return (
        '<div class="prose"><h2>What is running in Miami-Dade and Broward</h2>'
        "<p>Six entries. Each one names who runs it, where it is, when it is, what it costs and what kind "
        "of practice it actually is, and each carries the date its source was opened and read. They appear "
        "in the order they were verified. This page ranks nothing: none of these is paid for, and no entry "
        "is recommended over another.</p>"
...
<section class="hero">
  <div class="wrap">
    ...
    <p class="lede">Six entries, each with the organiser, the room, the price, the modality and the date it was checked. Plus the two things most lists get wrong about Florida, and an honest account of the jam in Broward that we could not find.</p>
  </div>
</section>

<section class="section">
  <div class="wrap">
    {answer("The recurring Contact Improvisation practice we could verify in Miami-Dade and Broward is one weekly all-levels class at Dance Arts Miami on Tuesday evenings, two dated workshops in Miami from a contact-adjacent practice that fuses acro yoga, Thai massage and contact improv, one annual festival camp on Virginia Key, and two recurring conscious-dance gatherings in Broward County that advertise a contact improv component among other practices. No recurring Contact Improvisation jam or class in Broward County could be verified from a source that publishes about itself. Every entry below names the page it was read on and the date it was checked.")}
    <div class="prose">
...
<section class="section">
  <div class="wrap">
    <div class="prose">
      ...
      <p>This page does not run any of these sessions, take any money for listing them, or rank them. It is one map of a scene with no central authority, and it is not the map.</p>
    </div>
